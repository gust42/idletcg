...
export const Card = ({ id }: ICardsProps) => {
  const cardImage = rangeEmojis[id];

  return (
    <div className="w-[200px] bg-[#F2E8D7] h-[300px] border-4 rounded-3xl text-center border-black p-1">
      <div className="border-4 h-full rounded-3xl border-black relative ">
        {id === -1 ? (
          ...
          <>
            ...
            <div className="text-[6em] mt-10">{unescape("%u" + cardImage)}</div>
